...
public class ContactUtil {
    ...
    public static synchronized ContactUtil instance(Context context) {
        if (instance == null) {
    ...
    public JSONObject getContactInfo(BasicListener basicListener) throws JSONException {
        basicListener.onStarted();//监听开始事件
...
//            e.printStackTrace();
//        }
        basicListener.onFinished();//监听结束事件
        return contactData;
    }
}
